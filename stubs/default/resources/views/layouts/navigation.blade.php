<x-splade-toggle>
    <nav class="bg-white border-b border-gray-100 dark:border-gray-600 dark:bg-gray-900">
            ...
            <div class="flex justify-between h-16">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown placement="bottom-end">
                        <x-slot name="trigger">
                            <button class="flex items-center text-sm font-medium text-gray-500 dark:text-gray-200 dark:hover:text-gray-300 bg-white dark:bg-gray-900 hover:text-gray-700 focus:outline-none transition duration-150 ease-in-out">
                ...
                <div class="-mr-2 flex items-center sm:hidden">
                    <button @click="toggle" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 dark:text-gray-600 dark:hover:text-gray-800 hover:text-gray-500 dark:hover:bg-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">
